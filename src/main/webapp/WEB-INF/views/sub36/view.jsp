...
<body>
	...
	<br />
	<button id="btn3">json 전송3</button>
	<br />
	<button id="btn4">json 전송4</button>
	<br />
	<button id="btn5">json 전송5</button>
	<br />
	<button id="btn6">json 전송6</button>
	<br />
	<button id="btn7">json 전송7</button>
	<br />
