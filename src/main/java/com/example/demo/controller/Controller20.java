...
public class Controller20 {
	...
	public void method3() {
		String name = mapper.method4(5); // 5번 고객 이름 나옴
		System.out.println(name);
	}
	...
	public void method5(@RequestParam("id") Integer id) { // requestParam의 프로퍼티와 아규먼트가 같으면
		System.out.println(mapper.method5(id)); 		  // param 생략 가능
	}
