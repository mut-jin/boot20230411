...
<body>
	...
	<div>
		<button id="btn15">응답 본문 json from dto1</button>
	</div>
	<div>
		<button id="btn16">응답 본문 json from dto2</button>
	</div>
	<div>
		<button id="btn17">응답 본문 json from 17</button>
	</div>
	<div>
		<button id="btn18">응답 본문 json from 18</button>
	</div>
	<div>
		<button id="btn19">응답 본문 json from 19</button>
	</div>
	<div>
		<button id="btn20">응답 본문 json from db 20</button>
	</div>
	<div>
		<button id="btn21">응답 본문 json from db 21</button>
	</div>
	
	<hr />
		<input type="number" id="categoryIdInput" value="1"/>
		<button id="btn22">응답본문 json from db 22</button>
		<ul id="productList">
