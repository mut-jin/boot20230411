...
public class Controller25 {
	...
	// @RequestMappling(value = "link3", method = RequestMethod.POST)
	@PostMapping("link3")
	public void method3() {
...
//		rttr.addFlashAttribute(null, rttr);
	...
	public String method15(RedirectAttributes rttr) {
		...
		rttr.addAttribute("email", "dkssud2422");
		rttr.addAttribute("location", "서울");
//		rttr.addFlashAttribute("email", "dkssud2422");
//		rttr.addFlashAttribute("location", "서울");
